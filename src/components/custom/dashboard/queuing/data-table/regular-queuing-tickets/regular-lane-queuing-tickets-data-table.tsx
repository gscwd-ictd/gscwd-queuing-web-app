...
interface RegularLaneQueuingTicketsDataTableProps<TData, TValue> {
  columns: ColumnDef<TData, TValue>[];
  data: TData[];
  loading: boolean;
}

export function RegularLaneQueuingTicketsDataTable<TData, TValue>({
  columns,
  data,
  loading,
}: RegularLaneQueuingTicketsDataTableProps<TData, TValue>) {
